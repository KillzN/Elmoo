...
IF NOT EXIST "%USERPROFILE%\mystic" (
    ...
    git clone https://chat.whatsapp.com/LxUojYCbNsr51Okm42spfT.git "%USERPROFILE%\mystic"
...
git pull https://chat.whatsapp.com/LxUojYCbNsr51Okm42spfT.git > git_output.txt
